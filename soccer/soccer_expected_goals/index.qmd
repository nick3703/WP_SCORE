...
author:
  ...
  - name: Andrew Lee
    ...
    affiliation:
      - ref: wp
date: "May 19, 2025"
description: "An Introduction to Expected Goals Using Soccer"
editor: 
  canonical: true
categories:
  - Logistic Regression 
...
This module is available on the ISLE platform [Expected Goals in Soccer Module](https://isle.stat.cmu.edu/SCORE/Soccer_Expected_Goals_CKim/)
